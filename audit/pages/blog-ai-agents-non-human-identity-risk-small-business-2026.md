# Page Audit: /blog/ai-agents-non-human-identity-risk-small-business-2026

## Route
/blog/ai-agents-non-human-identity-risk-small-business-2026.html
...
| Visible publish date | Pass | `<time datetime="2026-07-13">` |
| BlogPosting JSON-LD with datePublished, dateModified, author as Person | Pass | |
| Exactly one H1 | Pass | |
| Title, meta description, canonical present | Pass | |
| FAQ JSON-LD matching visible text | Pass | 3 Q&A pairs verbatim-match body FAQ |
| Internal links to relevant service pages | Pass | Links to /cybersecurity plus related blog posts (shadow AI, OAuth app phishing) |
