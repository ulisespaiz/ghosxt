# Page Audit: /blog/microsoft-365-small-business-settings-to-turn-on-2026

## Route
/blog/microsoft-365-small-business-settings-to-turn-on-2026.html
...
|------|-----------|-------|
| Visible byline naming the author | Pass | line 182 |
| Visible publish date | Pass | `<time datetime="2026-05-30">May 30, 2026</time>` (line 174) |
| BlogPosting JSON-LD: datePublished, dateModified, author as Person | Pass | lines 47, 49-50 |
| Exactly one H1 | Pass | line 180 |
| Title, meta description, canonical present | Pass | lines 6-8 |
| FAQ JSON-LD matching visible text | Pass | 4 Q&As, verbatim match (lines 66-104 vs 250-263) |
| Internal links to relevant service pages | Pass | body links to /managed-it-services and /cloud-services (line 244) |
