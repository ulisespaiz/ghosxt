...
OLD_TEMPLATE_P1 = (
    ...
    'remotely and on-site help across {name} when hardware, a network drop, or a new-hire setup '
    'needs hands on site.'
)
OLD_TEMPLATE_P2 = (
