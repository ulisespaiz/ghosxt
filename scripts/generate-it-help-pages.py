...
CITIES = {
    "morgan-hill": {
        ...
        "lead": "Morgan Hill sits at the quiet end of Silicon Valley &mdash; close enough to the Bay Area's prices, far enough that the big-name IT firms treat a drive down 101 as an imposition. The result is a town full of professional offices, small manufacturers, wineries, and growing companies that get treated as an afterthought by their provider. Ghosxt is the opposite: a live help desk that answers, on-site response that actually shows up, and an engineer with DoD infrastructure experience who treats a Morgan Hill ten-person office like it matters &mdash; because it does.",
        ...
        "response": "Based on the Central Coast with a footprint up the 101 corridor, we cover Morgan Hill with same-day or next-day on-site visits for non-emergencies and immediate remote response for anything urgent. Most issues never need a truck roll &mdash; they are fixed remotely the same business day &mdash; but when hands-on work is required, you are not waiting for someone to find time between Bay Area accounts.",
    ...
    "scotts-valley": {
        ...
        "card_a": ("Support for Technical Teams", "A help desk that does not waste a capable team's time &mdash; fast escalation to a senior engineer for the server, identity, and Microsoft 365 issues that actually need expertise."),
        ...
        "faqs": [
            ...
            ("How fast is on-site response to Scotts Valley?", "Most issues are solved remotely the same business day. When something needs hands-on work, on-site response is typically same-day or next-day for non-emergencies &mdash; we cover the Santa Cruz area and the Highway 17 corridor directly."),
        ],
    },
    "aptos": {
        "name": "Aptos",
        ...
        "county": ("santa-cruz-county", "Santa Cruz County"),
        "nearby": [("santa-cruz", "Santa Cruz"), ("watsonville", "Watsonville")],
        "lead": "Aptos is small-business country in the best sense &mdash; professional offices around Cabrillo College's Aptos campus, real estate and law practices, medical and dental offices, restaurants and inns along the coast, and the trades and services that keep the community running. None of them are big enough to want an IT department, and all of them need IT that just works. Ghosxt is the local help desk and on-site engineer that fills that gap.",
    ...
    "carmel-valley": {
        ...
        "faqs": [
            ...
            ("Can you work discreetly with guests and clients present?", "Yes. Discretion is standard for us. On-site visits are scheduled around your hours, our engineer is professional and low-profile, and we never discuss client details &mdash; the same standard we held inside DoD networks."),
    ...
    "prunedale": {
        ...
        "economy": "Prunedale's businesses are practical and owner-run: contractors and trades, auto and equipment shops, growers and nurseries, and the retail and services clustered around the shopping centers at San Miguel Canyon and Vierra Canyon Roads where Highway 101 runs through &mdash; there's no incorporated downtown, just the unincorporated community the highway holds together. They run on a mix of office PCs, mobile devices in the field, and point-of-sale, and their IT trouble is the everyday kind &mdash; email that stopped, a quote that will not print, a device that will not connect. What they have lacked is simply someone nearby who answers and can drive out.",
        "response": "We are based in Salinas, minutes from Prunedale, so on-site response across north county is genuinely local &mdash; same-day or next-day for non-emergencies &mdash; with most issues solved remotely the same business day. For an owner-run business in a spread-out community, having support a short drive away beats a call center two hours up the freeway every time.",
    ...
    body = f"""      <section class="location-hero">
      ...
      <section class="location-section">
        <div class="container">
          ...
          <p>{city['economy']}</p>
          <p>That is the job we do: be the first call a {name} business makes, fix what is broken quickly, and quietly keep more of it from breaking. No phone tree, no overseas script, no waiting days for a callback &mdash; just a senior engineer and a help desk that treats your time as the thing that matters.</p>
        </div>
      </section>
...
{cards_html(cards)}
      ...
      <section class="location-cta">
        <div class="container">
          ...
          <p>30 minutes with a senior engineer. We review your systems, support history, Microsoft 365, and backups, and leave you a written, prioritized punch list of what to fix first &mdash; whether or not you become a client.</p>
          <a href="https://calendly.com/ulises-ghosxt" target="_blank" rel="noopener noreferrer" class="location-btn location-btn-primary">
            <i class="fi fi-rs-calendar-day" aria-hidden="true"></i>
