...
IT_HELP_META_DESC = {
    'aptos': 'On-site IT support and US-based help desk for Aptos professional offices: real estate, law, and medical practices near Cabrillo. Free assessment.',
...
CITIES = {
    "morgan-hill": {
        ...
        "lead": "Morgan Hill sits at the quiet end of Silicon Valley: close enough to the Bay Area's prices, far enough that the big-name IT firms treat a drive down 101 as an imposition. The result is a town full of professional offices, small manufacturers, wineries, and growing companies that get treated as an afterthought by their provider. Ghosxt is the opposite: a live help desk that answers, on-site response that actually shows up, and an engineer with DoD infrastructure experience who treats a Morgan Hill ten-person office like it matters, because it does.",
        "economy": "Morgan Hill's economy is a mix that demands responsive support: manufacturers and R&amp;D shops with real payrolls (Specialized Bicycle Components and Anritsu are both based here), medical practices that cannot see patients when the system is down, law and accounting offices on deadline, and the wineries along the Santa Clara Valley Wine Trail taking payments seven days a week. Downtown along Monterey Street, the professional offices and small retailers share the same low tolerance for being on hold. When email stops or a workstation dies, they need a person, not a ticket number and a 48-hour window.",
        "response": "Based on the Central Coast with a footprint up the 101 corridor, we cover Morgan Hill with on-site visits scheduled to fit your business and remote response for anything urgent. Most issues never need a truck roll (they are fixed remotely) but when hands-on work is required, you are not waiting for someone to find time between Bay Area accounts.",
        "card_a": ("Practice &amp; Office Uptime", "Medical and professional offices in Morgan Hill kept running: fast help-desk response so a frozen workstation or down server does not turn into a day of canceled appointments."),
        ...
        "faqs": [
            ("Do you provide IT support and help desk for Morgan Hill businesses?", "Yes. Ghosxt provides a live, US-based help desk and on-site IT support for Morgan Hill small and midsize businesses: day-to-day end-user support, Microsoft 365, monitoring and patching, and a senior engineer for anything complex. We cover the 101 corridor on-site and support businesses remotely nationwide."),
            ("How fast do you respond when something breaks?", "Most issues are resolved remotely rather than parked in a ticket queue, and critical incidents carry our 4-hour notification commitment. When a problem needs hands on the hardware, on-site response in Morgan Hill is scheduled to fit your business."),
    ...
    "capitola": {
        ...
        "lead": "Capitola runs on foot traffic: the Village boutiques, the beachfront restaurants, the salons and surf shops, and the small professional offices tucked behind them. For all of them, a down point-of-sale terminal or a dead Wi-Fi network on a busy Saturday is not an inconvenience, it is lost revenue that does not come back. Ghosxt gives Capitola's small businesses a help desk that answers fast and an engineer who understands that in a beach town, downtime has a season.",
        "economy": "Capitola's businesses are small, seasonal, and customer-facing: restaurants and cafes processing cards all day in Capitola Village along the Esplanade, retail and boutiques that live and die by the register, and the larger retailers along the 41st Avenue corridor serving the broader community. Their IT needs are not complicated, but they are urgent: when the card reader freezes during the Art &amp; Wine Festival crowd or the guest Wi-Fi drops on a summer weekend, they need help in minutes, not a callback tomorrow.",
        "response": "We are based on the Central Coast and cover Capitola and the greater Santa Cruz area with genuinely local on-site response, scheduled to fit your business, and most issues handled remotely. During the summer and holiday surge, when a busy weekend is the whole month's margin, that responsiveness is the entire point.",
        "card_a": ("Point-of-Sale &amp; Wi-Fi That Stays Up", "Fast support for the card terminals, registers, and guest Wi-Fi Capitola's restaurants and Village shops depend on, so a busy Saturday is not derailed by a frozen screen."),
        "card_b": ("Small-Team Microsoft 365 &amp; Email", "Email, booking systems, and everyday support for Capitola's salons, studios, and professional offices, handled by a person who answers: no in-house IT required."),
        "faqs": [
            ...
            ("Our POS or Wi-Fi goes down on busy days. Can you help fast?", "Yes, and that is the priority. Most register, terminal, and Wi-Fi issues are fixed remotely, and critical incidents carry our 4-hour notification commitment. When it needs an on-site visit, we schedule it to fit your business, and we can harden the setup so it stops happening."),
            ("We're a tiny business with no IT person. Is that a problem?", "Not at all. That is most of who we help in Capitola. You get a help desk to call when something breaks and proactive monitoring so less breaks in the first place, with flat, published pricing sized for a small team, including our Tiny Team plan."),
    ...
    "scotts-valley": {
        ...
        "lead": "Scotts Valley has a different character than the rest of the county: a cluster of technology firms, light manufacturers, and professional offices in the hills above Santa Cruz, many run by people who know enough about IT to know they should not be the ones doing it. Ghosxt gives them a help desk and a senior engineer who can keep up with a technical team, handle the day-to-day, and free the owner from being the accidental IT department.",
        "economy": "Scotts Valley's businesses skew technical and professional: the town was once home to Borland Software and Seagate Technology, and current employers like Ichor Systems and Threshold Enterprises keep that engineering character alive alongside the medical and professional offices that serve the area. Their staff are capable, which means the tickets that reach IT are the real ones: a misbehaving server, an identity or Microsoft 365 problem, a security question, a new-hire setup that needs to be right. They need a provider who responds quickly and actually understands the environment, not a script-reading call center.",
        "response": "Based on the Central Coast and covering the Santa Cruz area and the Highway 17 corridor, we provide Scotts Valley businesses with on-site response scheduled to fit your business and remote support for anything urgent, with most issues resolved remotely by an engineer who can speak to a technical team as a peer.",
        "card_a": ("Support for Technical Teams", "A help desk that does not waste a capable team's time: fast escalation to a senior engineer for the server, identity, and Microsoft 365 issues that actually need expertise."),
        ...
        "faqs": [
            ("Do you provide IT support and help desk for Scotts Valley businesses?", "Yes. Ghosxt provides a live, US-based help desk and on-site IT support for Scotts Valley's tech firms, manufacturers, and professional offices: end-user support, Microsoft 365, monitoring and patching, identity, and a senior engineer for complex work. Local on-site, remote nationwide."),
            ("Our team is technical. We need real support, not a call center. Is that you?", "Yes. Our help desk escalates quickly to a senior engineer instead of reading from a script, so a capable Scotts Valley team is not stuck explaining their environment to someone who does not understand it. You get peers, not gatekeepers."),
            ...
            ("How fast is on-site response to Scotts Valley?", "Most issues are solved remotely. When something needs hands-on work, on-site response is scheduled to fit your business, and critical incidents carry our 4-hour notification commitment. We cover the Santa Cruz area and the Highway 17 corridor directly."),
        ],
    },
    "aptos": {
        "name": "Aptos",
        ...
        "county": ("santa-cruz-county", "Santa Cruz County"),
        "nearby": [("santa-cruz", "Santa Cruz"), ("watsonville", "Watsonville")],
        "lead": "Aptos is small-business country in the best sense: professional offices around Cabrillo College's Aptos campus, real estate and law practices, medical offices, restaurants and inns along the coast, and the trades and services that keep the community running. None of them are big enough to want an IT department, and all of them need IT that just works. Ghosxt is the local help desk and on-site engineer that fills that gap.",
        "economy": "The Aptos economy is built on small professional and service businesses: realtors and attorneys handling sensitive client documents, medical practices on tight appointment schedules, accountants on deadline, and the retailers filling in around the Aptos Village redevelopment. Their IT is supposed to be invisible, until a workstation freezes, email stops, or a file will not open, and suddenly the whole day stalls. What they need is someone to call who fixes it fast and quietly keeps it from happening again.",
        "response": "We are based on the Central Coast and cover Aptos and the greater Santa Cruz area with local on-site response, scheduled to fit your business, and most problems handled remotely. For a small office where everyone wears several hats, having a help desk that simply answers is the difference between a five-minute interruption and a lost afternoon.",
        "card_a": ("Practice &amp; Office Support", "Medical, legal, and accounting offices in Aptos kept running: fast help-desk response and the document security these practices are obligated to maintain."),
        "card_b": ("No-IT-Department Coverage", "A complete help desk for businesses too small to hire IT: support when something breaks, monitoring so less does, and Microsoft 365 and email managed for you."),
        "faqs": [
            ...
            ("We don't have anyone in-house for IT. Can you be that for us?", "Yes. That is exactly what we do for most Aptos clients. You get a help desk to call when something breaks and proactive monitoring so fewer things break, without the cost of a full-time hire. Pricing is published upfront."),
            ("Can you handle the compliance side for a medical office?", "Yes. We support HIPAA-minded medical practices in Aptos with the access controls, backups, and documentation those obligations require, alongside the everyday help desk that keeps appointments on schedule."),
            ("How quickly can you respond?", "You reach the engineer directly rather than a ticket queue, and critical incidents carry our 4-hour notification commitment. When something needs an on-site visit, we schedule it to fit your business."),
        ],
    },
    "castroville": {
        "name": "Castroville",
        ...
        "lead": "Castroville is the Artichoke Center of the World, and behind that title is a working economy of growers, coolers, processors, and the trucking and small businesses that move product out of north Monterey County. It is the kind of town big IT firms drive past on the way to the Peninsula. Ghosxt does not drive past. We are based up the road in Salinas and bring Castroville's ag and small businesses a real help desk and on-site support.",
        "economy": "Castroville runs on agriculture and the businesses around it: growers and shippers with lean back offices, cooling and processing operations with equipment that cannot stop (Ocean Mist Farms, headquartered here, is one of the area's largest employers), trucking and logistics on tight schedules, and the family-run shops along old Merritt Street. Their IT problems are practical: an office PC that died mid-invoice, email that stopped, a scale or label system that will not talk to the network, and they need someone nearby who answers and shows up, not a ticket lost in a Bay Area queue.",
        "response": "We are based in Salinas, a short drive from Castroville, so on-site response across north county is genuinely local, scheduled to fit your business, with most issues solved remotely. For an operation running on a harvest schedule, a provider who is actually close by is worth more than one who looks good on paper and is two hours away.",
        "card_a": ("Ag Back-Office Support", "Fast help-desk support for the invoicing, scheduling, and email that keep a Castroville grower, cooler, or shipper running, handled by someone a short drive away."),
        "card_b": ("On-Site When It Counts", "Real on-site response across north Monterey County for the PC, network, and connected-equipment problems that cannot be fixed over the phone: no waiting half a day for a truck from the Bay."),
        "faqs": [
            ...
            ("How fast can you respond during harvest?", "Most issues are handled remotely, and on-site response is scheduled to fit your business. Critical incidents carry our 4-hour notification commitment. We plan around your season, because we know a stopped system during harvest costs real money."),
        ],
    },
    "greenfield": {
        "name": "Greenfield",
        ...
        "economy": "Greenfield's economy is agriculture end to end: lettuce, broccoli, and strawberry growers that make the Salinas Valley the source of roughly 60% of U.S. leaf lettuce, plus vineyards and wineries, packing and processing, and the lean offices that run them along El Camino Real. These businesses often run on aging hardware and whatever setup a relative configured years ago, with no one to call when it breaks. What they need is straightforward and overdue: a responsive help desk, reliable backups, and an engineer who will actually drive out.",
        "response": "We are based in Salinas, up the valley from Greenfield, and built our model around serving South County (Greenfield, Soledad, King City) directly. On-site response is real, not theoretical: scheduled to fit your business, with most issues solved remotely. The point is that someone finally answers.",
        "card_a": ("South County, Actually Served", "A help desk and on-site engineer for Greenfield growers, wineries, and shops that other providers treat as too far, based up the valley in Salinas, not the Bay Area."),
        ...
        "faqs": [
            ...
            ("Our setup is old and nobody manages it. Where do we start?", "Start with a free assessment. We will document what you have, tell you plainly what is at risk, and prioritize the fixes: usually reliable backups, email, and a help desk to call first. No obligation, and pricing is published upfront."),
            ("How fast can you respond out here?", "Most issues are resolved remotely. When on-site work is needed, response in Greenfield is planned around your harvest and operating schedule, and critical incidents carry our 4-hour notification commitment."),
        ],
    },
    "gonzales": {
        "name": "Gonzales",
        ...
        "county": ("monterey-county", "Monterey County"),
        "nearby": [("salinas", "Salinas")],
        "lead": "Gonzales is a small Salinas Valley city that punches above its weight: anchored by agriculture, food and beverage processing, and distribution operations that ship product well beyond the county. Those operations run on systems that cannot afford to stop, in a town most Bay Area IT firms consider out of range. Ghosxt is based up the valley in Salinas and gives Gonzales businesses a help desk and on-site support that is genuinely local.",
        "economy": "Gonzales blends large-scale food and beverage processing and distribution (much of it staged through the city's own Agricultural Business Industrial Park) with the growers, wineries along the River Road Wine Trail, trucking, and small businesses around them. The processors and distributors run line-of-business systems, scheduling, and connected equipment where downtime is expensive; the smaller offices need reliable email and a help desk to call. Both have the same complaint about IT in South County: when something breaks, no one nearby answers. That is the gap we close.",
        "response": "Based in Salinas, just up the valley, we cover Gonzales with on-site response and remote support. Most issues are fixed remotely. For a processor or distributor running on a schedule, having an engineer who is a short drive away rather than two hours up the 101 is the whole difference.",
        "card_a": ("Processing &amp; Distribution Uptime", "Responsive support for the scheduling, line-of-business, and network systems Gonzales processors and distributors run on, so a glitch is a quick call, not a stopped line."),
    ...
    "san-juan-bautista": {
        ...
        "lead": "San Juan Bautista is a small historic town that runs on tourism and character: the mission, the restaurants and tasting rooms, the antique shops and galleries, and the small offices and growers in the surrounding hills. Its businesses are tiny, customer-facing, and the last thing they want is to fight with technology while visitors are at the counter. Ghosxt gives them a help desk that answers and an engineer nearby in Hollister and Salinas.",
        "economy": "San Juan Bautista's economy is hospitality and small retail built around the historic Mission and Plaza Historic District: restaurants and wine tasting rooms taking cards, shops and galleries running point-of-sale, inns serving visitors, and the small professional offices and growers around town (Earthbound Farms, one of the country's largest organic salad producers, is based here). Their IT needs are modest but time-sensitive: a frozen register or dropped Wi-Fi on a busy tourist weekend is lost business, so what matters is fast, friendly support and a setup that quietly stays up.",
        "response": "We are based on the Central Coast with a footprint in nearby Hollister and Salinas, so San Juan Bautista gets genuinely local coverage: on-site visits scheduled to fit your business, with most issues fixed remotely. In a town where a single busy weekend matters, that responsiveness is the point.",
        ...
        "card_b": ("Small &amp; Historic-Town Friendly", "A patient, plain-English help desk for tiny businesses with no IT person: quick fixes, reliable email, and a setup that stays out of the way of your guests."),
        "faqs": [
            ...
            ("Our register or Wi-Fi fails on busy weekends. Can you fix that fast?", "Yes, and that is the priority. Most point-of-sale and Wi-Fi issues are resolved remotely, and we can harden the setup so it stops happening. On-site response is scheduled to fit your business when hands-on work is needed, and critical incidents carry our 4-hour notification commitment."),
    ...
    "carmel-valley": {
        ...
        "lead": "Carmel Valley is wine country with a quiet, high-end clientele: tasting rooms and vineyards, resorts and spas, real estate and the professional offices that serve affluent residents. Like Carmel itself, it trades on discretion and reputation, which makes both downtime and a data breach expensive in ways that go beyond the bill. Ghosxt brings Carmel Valley businesses a responsive help desk and on-site engineer who works quietly and keeps things running.",
        "economy": "Carmel Valley's economy centers on hospitality and high-value services: the two dozen tasting rooms of the Carmel Valley AVA (its own federally recognized wine appellation since 1983) taking payments and running wine clubs along Carmel Valley Road, resorts and spas with booking and guest systems, and real estate, legal, and financial offices handling significant transactions. These businesses need support that is both fast and discreet: when a tasting-room register freezes during a busy afternoon or a real estate office cannot reach its files, they need a quiet, capable response, not a disruption in front of guests.",
        "response": "We are based on the Central Coast and cover Carmel Valley with on-site response and remote support, with most issues resolved remotely. On-site visits are scheduled around your guests and clients and handled low-profile: the same discretion we hold across Carmel and the Peninsula.",
        "card_a": ("Winery &amp; Tasting-Room Support", "Fast, quiet support for the point-of-sale, wine-club, and booking systems Carmel Valley's wineries and resorts run on, kept up through every busy weekend."),
        ...
        "faqs": [
            ...
            ("Can you work discreetly with guests and clients present?", "Yes. Discretion is standard for us. On-site visits are scheduled around your hours, our engineer is professional and low-profile, and we never discuss client details: the same standard we held inside DoD networks."),
            ...
            ("How fast do you respond?", "Most issues are resolved remotely. When on-site work is needed, response in Carmel Valley is scheduled around your guests and clients, and critical incidents carry our 4-hour notification commitment."),
        ],
    },
    "prunedale": {
        "name": "Prunedale",
        ...
        "county": ("monterey-county", "Monterey County"),
        "nearby": [("salinas", "Salinas"), ("marina", "Marina"), ("monterey", "Monterey"), ("watsonville", "Watsonville")],
        "lead": "Prunedale is North Monterey County's crossroads: a spread-out community along Highway 101 of trades, contractors, small retail, growers, and family businesses that serve the area. It has no downtown and no IT firm of its own, which usually means no one to call when technology breaks. Ghosxt is based minutes away in Salinas and gives Prunedale's businesses a real help desk and on-site support close to home.",
        "economy": "Prunedale's businesses are practical and owner-run: contractors and trades, auto and equipment shops, growers and nurseries, and the retail and services clustered around the shopping centers at San Miguel Canyon and Vierra Canyon Roads where Highway 101 runs through. There's no incorporated downtown, just the unincorporated community the highway holds together. They run on a mix of office PCs, mobile devices in the field, and point-of-sale, and their IT trouble is the everyday kind: email that stopped, a quote that will not print, a device that will not connect. What they have lacked is simply someone nearby who answers and can drive out.",
        "response": "We are based in Salinas, minutes from Prunedale, so on-site response across north county is genuinely local, scheduled to fit your business, with most issues solved remotely. For an owner-run business in a spread-out community, having support a short drive away beats a call center two hours up the freeway every time.",
...
SHARED_CARDS = [
    ("Live, US-Based Help Desk", "A real person answers: remote support for the day-to-day issues that stop work, without being parked in a ticket queue."),
    ("On-Site Response", "When a problem needs hands on the hardware, we drive out. Based on the Central Coast, on-site visits to {name} are scheduled to fit your business."),
    ("Proactive Monitoring &amp; Patching", "We watch your systems and patch them before they fail, so most problems are prevented: fewer tickets, less downtime, and no surprise outages."),
    ("Microsoft 365 &amp; New-Hire Setup", "Email, Teams, passwords, onboarding and offboarding, and the everyday Microsoft 365 questions your team actually has, handled quickly so people can get back to work."),
]
...
def build_page(chrome, slug, city):
    ...
    og_desc = f"A live help desk and genuinely local on-site IT support for {name} small business, from an engineer with DoD infrastructure experience."
    ...
    schema_desc = (
        ...
        "and cybersecurity from an engineer with DoD infrastructure experience."
    )
    ...
    body = f"""      <section class="location-hero">
        <div class="container">
          ...
          <p class="pricing-trust-callout"><a href="/pricing">Help desk and IT support are built into every managed plan: pricing published upfront.</a></p>
        </div>
      </section>
      ...
      <section class="location-section">
        <div class="container">
          ...
          <p>{city['economy']}</p>
          <p>That is the job we do: be the first call a {name} business makes, fix what is broken quickly, and quietly keep more of it from breaking. No phone tree, no overseas script, no waiting days for a callback: just a senior engineer and a help desk that treats your time as the thing that matters.</p>
        </div>
      </section>
      ...
      <section class="location-section">
        <div class="container">
          ...
          <p>A complete help desk and managed IT, sized for a small business in {name}: the everyday support your team needs, plus the monitoring, security, and backup that keep problems from becoming emergencies.</p>
...
{cards_html(cards)}
      ...
      <section class="location-cta">
        <div class="container">
          ...
          <p>30 minutes with a senior engineer. We review your systems, support history, Microsoft 365, and backups, and leave you a written, prioritized punch list of what to fix first, whether or not you become a client.</p>
          <a href="https://calendly.com/ulises-ghosxt" target="_blank" rel="noopener noreferrer" class="location-btn location-btn-primary">
            <i class="fi fi-rs-calendar-day" aria-hidden="true"></i>
      ...
      <section class="location-section">
        <div class="container">
          ...
          <p>Day-to-day support works best when the same team also runs and secures the systems behind it. Our {name} help desk sits inside <a href="/managed-it-services">managed IT</a> (monitoring, patching, <a href="/cybersecurity">cybersecurity</a>, <a href="/cloud-services">Microsoft 365 and cloud</a>, and <a href="/backup-disaster-recovery">backup</a>), so the engineer who answers your ticket is the one who knows your environment. For the full picture of our support model, see <a href="/help-desk-it-support">IT help desk &amp; support</a>.</p>
