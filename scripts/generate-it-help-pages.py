...
CITIES = {
    ...
    "capitola": {
        ...
        "response": "We are based on the Central Coast and cover Capitola and the greater Santa Cruz area with genuinely local on-site response (same-day or next-day for non-emergencies) and most issues handled remotely the same business day. During the summer and holiday surge, when a busy weekend is the whole month's margin, that responsiveness is the entire point.",
    ...
    "scotts-valley": {
        ...
        "faqs": [
            ...
            ("How fast is on-site response to Scotts Valley?", "Most issues are solved remotely the same business day. When something needs hands-on work, on-site response is typically same-day or next-day for non-emergencies. We cover the Santa Cruz area and the Highway 17 corridor directly."),
        ],
    },
    "aptos": {
        "name": "Aptos",
        ...
        "county": ("santa-cruz-county", "Santa Cruz County"),
        "nearby": [("santa-cruz", "Santa Cruz"), ("watsonville", "Watsonville")],
        "lead": "Aptos is small-business country in the best sense: professional offices around Cabrillo College's Aptos campus, real estate and law practices, medical and dental offices, restaurants and inns along the coast, and the trades and services that keep the community running. None of them are big enough to want an IT department, and all of them need IT that just works. Ghosxt is the local help desk and on-site engineer that fills that gap.",
        ...
        "response": "We are based on the Central Coast and cover Aptos and the greater Santa Cruz area with local on-site response (same-day or next-day for non-emergencies) and most problems handled remotely the same business day. For a small office where everyone wears several hats, having a help desk that simply answers is the difference between a five-minute interruption and a lost afternoon.",
        "card_a": ("Practice &amp; Office Support", "Dental, medical, legal, and accounting offices in Aptos kept running: fast help-desk response and the document security these practices are obligated to maintain."),
        ...
        "faqs": [
            ...
            ("How quickly can you respond?", "Most issues are resolved remotely the same business day, because we answer in real time rather than queuing tickets. When something needs an on-site visit, response in Aptos is typically same-day or next-day for non-emergencies."),
        ],
    },
    "castroville": {
        "name": "Castroville",
        ...
        "response": "We are based in Salinas, a short drive from Castroville, so on-site response across north county is genuinely local (same-day or next-day for non-emergencies), with most issues solved remotely the same business day. For an operation running on a harvest schedule, a provider who is actually close by is worth more than one who looks good on paper and is two hours away.",
        ...
        "faqs": [
            ...
            ("How fast can you respond during harvest?", "Most issues are handled remotely the same business day, and on-site response is same-day or next-day for non-emergencies. We plan around your season, because we know a stopped system during harvest costs real money."),
        ],
    },
    "greenfield": {
        "name": "Greenfield",
        ...
        "response": "We are based in Salinas, up the valley from Greenfield, and built our model around serving South County (Greenfield, Soledad, King City) directly. On-site response is real, not theoretical: same-day or next-day for non-emergencies, with most issues solved remotely the same business day. The point is that someone finally answers.",
        ...
        "faqs": [
            ...
            ("How fast can you respond out here?", "Most issues are resolved remotely the same business day. When on-site work is needed, response in Greenfield is same-day or next-day for non-emergencies, planned around your harvest and operating schedule."),
        ],
    },
    "gonzales": {
        "name": "Gonzales",
    ...
    "san-juan-bautista": {
        ...
        "response": "We are based on the Central Coast with a footprint in nearby Hollister and Salinas, so San Juan Bautista gets genuinely local coverage (same-day or next-day on-site for non-emergencies), with most issues fixed remotely the same business day. In a town where a single busy weekend matters, that responsiveness is the point.",
    ...
    "carmel-valley": {
        ...
        "response": "We are based on the Central Coast and cover Carmel Valley with same-day or next-day on-site response for non-emergencies and immediate remote support, with most issues resolved remotely the same business day. On-site visits are scheduled around your guests and clients and handled low-profile: the same discretion we hold across Carmel and the Peninsula.",
        ...
        "faqs": [
            ...
            ("How fast do you respond?", "Most issues are resolved remotely the same business day. When on-site work is needed, response in Carmel Valley is typically same-day or next-day for non-emergencies, scheduled around your guests and clients."),
        ],
    },
    "prunedale": {
        "name": "Prunedale",
        ...
        "response": "We are based in Salinas, minutes from Prunedale, so on-site response across north county is genuinely local (same-day or next-day for non-emergencies), with most issues solved remotely the same business day. For an owner-run business in a spread-out community, having support a short drive away beats a call center two hours up the freeway every time.",
...
SHARED_CARDS = [
    ("Live, US-Based Help Desk", "Real people who answer: remote support for the day-to-day issues that stop work, with most tickets resolved the same hour instead of parked in a queue."),
