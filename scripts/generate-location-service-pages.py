...
CYBER_META_DESC = {
    'carmel': 'Cybersecurity for Carmel-by-the-Sea galleries, inns &amp; shops: MDR, wire-fraud defense, PCI, 24/7 monitoring. Discrete, local. Free assessment.',
    'gilroy': 'Cybersecurity for Gilroy warehouses, 3PLs, food processors &amp; retailers: MDR, MFA, ransomware protection, 24/7 monitoring. Free assessment.',
    'hollister': 'Cybersecurity for Hollister machine shops, vineyards &amp; family businesses in San Benito County: MDR, MFA, 24/7 monitoring. Free assessment.',
    'marina': "Cybersecurity for Marina's fast-growing businesses: MDR, phishing-resistant MFA, identity hardening, cloud backup, 24/7 monitoring. Free assessment.",
    'monterey': 'Cybersecurity for Monterey businesses: MDR, MFA, cloud backup, 24/7 monitoring. For hospitality, defense contractors &amp; healthcare. Free assessment.',
    'pacific-grove': 'Government-grade cybersecurity for Pacific Grove small business: MDR, MFA, identity hardening, cloud backup, 24/7 monitoring. Free assessment.',
    'salinas': 'Cybersecurity for Salinas businesses: MDR, MFA, cloud backup, 24/7 monitoring. Built for agriculture, food processing &amp; logistics. Free assessment.',
    'san-jose': 'Cybersecurity for San Jose businesses: MDR, MFA, cloud backup, 24/7 monitoring. Silicon Valley security without the pricing. Free assessment.',
    'santa-cruz': 'Cybersecurity for Santa Cruz businesses: MDR, MFA, cloud backup, 24/7 monitoring. Built for tech startups, tourism &amp; healthcare. Free assessment.',
    'seaside': 'Government-grade cybersecurity for Seaside small business: MDR, MFA, identity hardening, cloud backup, 24/7 monitoring. Free assessment.',
    'watsonville': 'Cybersecurity for Watsonville businesses: MDR, MFA, cloud backup, 24/7 monitoring. For berry farms, food processing &amp; cold storage. Free assessment.',
}
...
CONTENT = {
    ...
    "gilroy": {
        ...
        "cyber_threat2": "The defenses are the same proven controls in each case: managed detection and response, hardened identity, cloud backup, network segmentation, and a human watching. What changes is the cost of being wrong, and for a business that runs on uptime, that cost is steep.",
        "cyber_card_a": ("Logistics Uptime &amp; Ransomware", "Managed detection and response and cloud backup tuned for warehouse, dispatch, and 3PL systems that cannot go down, so a ransomware hit is a contained incident, not a week of stopped freight."),
        ...
        "cyber_diff": "Distribution and food businesses increasingly face two pressures at once: cyber-insurers demanding real controls before they renew, and larger retail and grocery customers sending security questionnaires before they sign. We put the same controls in place that satisfy both (MFA, managed detection and response, cloud backup, email security) and produce the documentation to prove it. Our <a href=\"blog/cyber-insurance-renewal-checklist-small-business-central-coast.html\">cyber-insurance renewal checklist</a> and <a href=\"blog/backup-disaster-recovery-small-business-2026.html\">backup and disaster-recovery guide</a> are good starting points.",
        "cyber_faq": [
            ("Do you provide cybersecurity for small businesses in Gilroy?", "Yes. Ghosxt provides full cybersecurity for Gilroy small and midsize businesses: managed detection and response (MDR), phishing-resistant MFA, identity hardening, cloud backup, network segmentation, and 24/7 monitoring. We work on-site across South County and the 101 corridor and remotely nationwide."),
            ("Can you protect a warehouse or 3PL from ransomware?", "Yes. Logistics businesses are heavily targeted because downtime is so costly. We deploy managed detection and response with a 24/7 SOC, off-network backup copies the production network cannot reach, and segmentation so an infected PC cannot reach dispatch and warehouse systems."),
    ...
    "hollister": {
        ...
        "cyber_threat2": "The fix is the same proven set of controls used on government endpoints, sized down without being dumbed down: managed detection and response, hardened identity, cloud backup, and segmentation between the shop floor and the office. The difference with Ghosxt is that on-site help is a short drive, not a half-day from the Bay Area.",
        "cyber_card_a": ("Shop-Floor &amp; CAD Protection", "Managed detection and response and cloud backup for machine-shop and manufacturing systems, with the office network segmented away from connected equipment so a compromise cannot jump to the floor."),
        ...
        "cyber_diff": "Hollister businesses do not usually face a federal compliance regime, but they do face cyber-insurers who now require real controls, and manufacturers face customers who send security questionnaires before awarding work. We put the controls in place that satisfy both (MFA, managed detection and response, cloud backup, email security) and document them. See our <a href=\"blog/cyber-insurance-renewal-checklist-small-business-central-coast.html\">cyber-insurance renewal checklist</a> and the rundown of <a href=\"blog/small-business-cybersecurity-mistakes.html\">common small-business security mistakes</a>.",
        "cyber_faq": [
            ("Do you provide cybersecurity for small businesses in Hollister?", "Yes. Ghosxt provides full cybersecurity for Hollister and San Benito County small businesses: managed detection and response (MDR), phishing-resistant MFA, identity hardening, cloud backup, and 24/7 monitoring. We are nearby, so on-site response is a short drive, not a half-day trip."),
            ("Is my business too small to be a target?", "No. Automated ransomware and phishing do not target by size, they target by opportunity. Small, lean businesses are often easier to breach because no one is watching. The good news is the highest-leverage controls, like MFA and managed detection and response, are affordable and stop the bulk of attacks."),
            ("Can you protect a machine shop's CAD files and equipment?", "Yes. We deploy managed detection and response and cloud backup for shop systems and CAD data, and segment the office network from connected equipment so a compromised PC cannot reach the floor."),
    ...
    "marina": {
        ...
        "cyber_threat2": "The controls that stop this are the same proven set used on government endpoints: phishing-resistant MFA, managed detection and response, hardened identity, cloud backup. The trick for a growing company is building them in early so they scale, instead of bolting them on after an incident forces the issue.",
        "cyber_card_a": ("Identity for Growing Teams", "Phishing-resistant MFA, Conditional Access, and least-privilege access standardized before headcount sprawl turns into a breach. This is the highest-leverage control on a growing network."),
        "cyber_card_b": ("Startup &amp; Ag-Tech Readiness", "The managed detection and response, backup, and documented controls that let a young Marina company answer a customer or investor security review and win the work."),
        "cyber_diff": "As Marina startups and ag-tech firms land larger clients, those clients start sending security questionnaires, and cyber-insurers want the same controls before they renew. We put MFA, managed detection and response, cloud backup, and email security in place and document them so you can pass the review and the audit. Our guide to <a href=\"blog/identity-hardening-small-business-5-employees-microsoft-365.html\">identity hardening for a small Microsoft 365 team</a> is the first move every growing company should make.",
        "cyber_faq": [
            ("Do you provide cybersecurity for small businesses in Marina?", "Yes. Ghosxt provides full cybersecurity for Marina small and growing businesses: managed detection and response (MDR), phishing-resistant MFA, identity hardening, cloud backup, and 24/7 monitoring. On-site across the Peninsula, remote nationwide."),
            ...
            ("Can you help us pass a customer's or investor's security review?", "Yes. We put the controls and documentation in place (MFA, managed detection and response, backups, access policies, written procedures) so when a larger client or investor sends a security questionnaire, you can answer it and win the work."),
        ...
        "cloud_economy": "Growing companies need email, files, and collaboration that work for hybrid and remote teams from day one, identity that scales as they hire, and the ability to add a line-of-business app in Azure without standing up a server. Startups and ag-tech firms want to look credible to customers and investors. Microsoft 365 and Azure deliver all of it, but only when the foundation is built to scale and hardened correctly, instead of cobbled together and outgrown.",
    ...
    "pacific-grove": {
        ...
        "cyber_threat2": "The controls that stop this are the same proven set used on government endpoints: PCI-aware point-of-sale security, segmented guest Wi-Fi, phishing-resistant MFA, managed detection and response, and cloud backup. In a town this small, the other requirement is discretion, and that is built into how we work.",
        ...
        "cyber_card_b": ("Booking &amp; Guest-Data Defense", "Email hardening and cloud backup around the booking and reservation systems that hold guest and card data, so a compromise does not become a guest-trust problem."),
        "cyber_diff": "Pacific Grove businesses rarely face a federal compliance regime, but those that take cards face PCI obligations, and all of them face cyber-insurers who now require MFA, managed detection and response, cloud backup, and email security before they renew. We put those controls in place and document them. Our <a href=\"blog/cyber-insurance-renewal-checklist-small-business-central-coast.html\">cyber-insurance renewal checklist</a> and note on <a href=\"blog/small-business-cybersecurity-mistakes.html\">common small-business security mistakes</a> cover the essentials.",
        "cyber_faq": [
            ("Do you provide cybersecurity for small businesses in Pacific Grove?", "Yes. Ghosxt provides full cybersecurity for Pacific Grove small businesses: managed detection and response (MDR), phishing-resistant MFA, identity hardening, cloud backup, PCI-aware point-of-sale security, and 24/7 monitoring. On-site in PG and across the Peninsula, handled discreetly."),
            ...
            ("We're a very small business. Is this affordable?", "Yes. Fit depends on your operating profile, not headcount. Very small teams use our flat-rate Tiny Team plan, and the highest-leverage controls (MFA and managed detection and response) are affordable and stop the bulk of attacks."),
    ...
    "seaside": {
        ...
        "cyber_threat2": "The fix is the same proven set of controls used on government endpoints, sized for a small business: managed detection and response, phishing-resistant MFA, cloud backup, segmented payment networks, and a human watching 24/7. Being based on the Central Coast means on-site help is genuinely local.",
        ...
        "cyber_faq": [
            ("Do you provide cybersecurity for small businesses in Seaside?", "Yes. Ghosxt provides full cybersecurity for Seaside small businesses: managed detection and response (MDR), phishing-resistant MFA, identity hardening, cloud backup, PCI-aware point-of-sale security, and 24/7 monitoring. On-site across the Peninsula, remote nationwide."),
            ...
            ("We're a small shop or nonprofit. Is this affordable?", "Yes. Fit depends on your operating profile, not headcount. Very small teams use our flat-rate Tiny Team plan, and the highest-leverage controls (MFA and managed detection and response) are affordable and stop most attacks."),
            ("How fast can you get on-site to Seaside?", "On-site visits are scheduled to fit your business, and most issues are resolved remotely. We are based on the Central Coast, so Peninsula on-site response is genuinely local."),
        ],
...
CLOUD_SHARED_CARDS = [
    ...
    ("Cloud Backup &amp; Identity", "Cloud <a href=\"backup-disaster-recovery.html\">backup</a> for Microsoft 365 data (email, SharePoint, and OneDrive) that Microsoft does not protect the way most businesses assume, plus Entra ID and Conditional Access configured so that every account is covered, not just the ones someone thought to enroll."),
]
...
def build_page(chrome, service, slug, city):
    ...
    if service == "cybersecurity":
        ...
        meta_desc = CYBER_META_DESC.get(slug) or (
            ...
            "managed detection and response, phishing-resistant MFA, identity hardening, "
            "cloud backup, and 24/7 monitoring from an engineer with DoD infrastructure experience. Free assessment."
        )
        ...
        schema_desc = (
            f"Government-grade cybersecurity for {name}, California small business: managed "
            "detection and response, phishing-resistant MFA, identity hardening, cloud backup, "
...
{cards_html(cards)}
      ...
      <section class="location-section">
        <div class="container">
          ...
          <p>We are based on the Central Coast, so on-site response in {name} is genuinely local, scheduled to fit your business for non-emergencies, and critical incidents carry our 4-hour notification commitment. We also serve {nearby}.</p>
        </div>
      </section>
