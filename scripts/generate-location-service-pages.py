...
def build_page(chrome, service, slug, city):
    ...
    if service == "cybersecurity":
        ...
        og_desc = f"Government-grade cybersecurity for {name} small business, from a DoD-cleared engineer."
        ...
        schema_desc = (
            ...
            "vulnerability management, and 24/7 monitoring from a DoD-cleared engineer."
        )
...
{faq_details(faqs)}
      ...
      <section class="location-cta">
        ...
        schema_desc = (
            ...
            "OneDrive, and Azure and hybrid environments, from a DoD-cleared engineer."
        )
