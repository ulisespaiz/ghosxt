...
def section_html(slug, name):
    return f"""      <section class="location-section">
        ...
        <div class="container">
          ...
          <p>Need a specific service in {name}? Go straight to the detail page for the work you have in mind. Each is delivered locally (on-site across the area and remotely nationwide) and runs on the same managed foundation with one senior engineer behind it.</p>
          <div class="services-grid">
            <article class="service-card"><h3>Cybersecurity in {name}</h3><p>Managed detection and response, phishing-resistant MFA, cloud backup, and 24/7 monitoring: government-grade, sized for a {name} small business.</p><a href="cybersecurity-{slug}.html">{name} cybersecurity</a></article>
            ...
            <article class="service-card"><h3>Managed IT</h3><p>Monitoring, patching, and a real senior engineer who answers the phone: the foundation every other service sits on.</p><a href="managed-it-services.html">Managed IT services</a></article>
            <article class="service-card"><h3>IT Help Desk &amp; Support</h3><p>Live, US-based help desk for your {name} team, with most issues fixed remotely and on-site help when hardware needs hands.</p><a href="help-desk-it-support.html">IT help desk &amp; support</a></article>
            <article class="service-card"><h3>Backup &amp; Disaster Recovery</h3><p>Cloud backup, tested restores, and a real recovery plan, so an outage or ransomware hit is a bad day, not a closed business.</p><a href="backup-disaster-recovery.html">Backup &amp; disaster recovery</a></article>
